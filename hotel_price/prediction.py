...
with open(os.path.join(output_dir, 'name_report.txt'), 'w') as f:
    f.write(name_report)
with open(os.path.join(output_dir, 'place_report.txt'), 'w') as f:
    f.write(place_report)
with open(os.path.join(output_dir, 'price_mse.txt'), 'w') as f:
